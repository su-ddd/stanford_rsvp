...
class StanfordRsvpTicket
{
    ...
    {
        // if someone entered 0, there is no space available
        if (($this->max_attendees === 0) || ($this->max_attendees === '0')) {
            return FALSE;
        }

        // if there is no setting, or it's empty, or it's set or the total number of attendees is lower,
        // there is space available, otherwise there isn't.
    ...
    {
        // if someone entered 0, there is no space available
        if (($this->max_waitlist === 0) || ($this->max_waitlist === '0')) {
            return FALSE;
        }
