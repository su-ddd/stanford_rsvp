...
/**
 * Field formatter "stanford_rsvp_ticket_default".
 *
 * @FieldFormatter(
 ...
 * )
 */
class StanfordRSVPTicketDefaultFormatter extends FormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($items as $delta => $item) {
      ...
      $build['name'] = array(
        '#type' => 'container',
        '#attributes' => array(
          'class' => array('stanford_rsvp_ticket__name'),
        ),
        'label' => array(
          '#type' => 'container',
          '#attributes' => array(
